...
const CONCEITOS = {
  ...
  "ICMS/LC 87/96 - Lei Kandir": "Lei Kandir (LC 87/96) — compensação pela perda de arrecadação de ICMS nas exportações.",
  ...
  "AUX":                   "Auxílio Financeiro aos Estados — repasse complementar da União para apoio financeiro pontual.",
